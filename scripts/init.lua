...
ScriptHost:LoadScript("scripts/randovania/output/tallon_overworld__elevator_to_chozo_ruins_transport_to_tallon_overworld_east__paths__1.lua")
ScriptHost:LoadScript("scripts/randovania/output/tallon_overworld__elevator_to_chozo_ruins_transport_to_tallon_overworld_north__paths__1.lua")
ScriptHost:LoadScript("scripts/randovania/output/tallon_overworld__elevator_to_chozo_ruins_transport_to_tallon_overworld_south__paths__1.lua")
ScriptHost:LoadScript("scripts/randovania/output/tallon_overworld__elevator_to_magmoor_caverns_transport_to_tallon_overworld_west__paths__1.lua")
ScriptHost:LoadScript("scripts/randovania/output/tallon_overworld__elevator_to_phazon_mines_transport_to_tallon_overworld_south__paths__1.lua")
ScriptHost:LoadScript("scripts/randovania/output/tallon_overworld__ship__paths__1.lua")
ScriptHost:LoadScript("scripts/randovania/output/tallon_overworld__teleport_to_impact_crater_crater_impact_point__paths__1.lua")
...
-- ScriptHost:LoadScript("scripts/randovania/output/chozo_ruins__elevator_to_tallon_overworld_transport_to_chozo_ruins_south__paths__1.lua")
...
-- ScriptHost:LoadScript("scripts/randovania/output/phendrana_drifts__elevator_transport_to_phendrana_drifts_north__paths__1.lua")
ScriptHost:LoadScript("scripts/randovania/output/phendrana_drifts__elevator_transport_to_phendrana_drifts_south__paths__1.lua")
ScriptHost:LoadScript("scripts/randovania/output/phendrana_drifts__elevator_transport_to_phendrana_drifts_south__paths__2.lua")
-- ScriptHost:LoadScript("scripts/randovania/output/phendrana_drifts__elevator_transport_to_phendrana_drifts_south__paths__3.lua")
-- ScriptHost:LoadScript("scripts/randovania/output/phendrana_drifts__elevator_transport_to_phendrana_drifts_south__paths__4.lua")
-- ScriptHost:LoadScript("scripts/randovania/output/phendrana_drifts__elevator_transport_to_phendrana_drifts_south__paths__5.lua")
-- ScriptHost:LoadScript("scripts/randovania/output/phendrana_drifts__elevator_transport_to_phendrana_drifts_south__paths__6.lua")
